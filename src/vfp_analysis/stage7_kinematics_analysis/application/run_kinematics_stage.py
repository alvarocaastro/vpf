...
from vfp_analysis.stage6_vpf_analysis.core.domain.optimal_incidence import PitchAdjustment
from vfp_analysis.stage7_kinematics_analysis.core.services.kinematics_service import compute_kinematics
...
def run_kinematics_stage() -> None:
    ...
    try:
        stage6_tables = base_config.get_stage_dir(6) / "tables"
        vpf_df = pd.read_csv(stage6_tables / "vpf_pitch_adjustment.csv")
