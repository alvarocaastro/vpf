...
from vfp_analysis.stage5_publication_figures.figure_generator import SECTION_COLORS
from vfp_analysis.stage6_vpf_analysis.adapters.filesystem.data_loader_adapter import (
    FilesystemDataLoader,
)
from vfp_analysis.stage6_vpf_analysis.adapters.filesystem.results_writer_adapter import (
    FilesystemVpfResultsWriter,
)
from vfp_analysis.stage6_vpf_analysis.core.services.optimal_incidence_service import (
    compute_all_optimal_incidences,
)
from vfp_analysis.stage6_vpf_analysis.core.services.pitch_adjustment_service import (
    compute_pitch_adjustments,
)
from vfp_analysis.stage6_vpf_analysis.core.services.summary_generator_service import (
...
def run_vpf_analysis() -> None:
    ...
    tables_dir       = output_dirs["tables_vpf"]
